...
import { getNotionalActionFromHintState, getPoolButtonIdSDKV2, setPageTitle } from '@utilities';
...
const ConnectedSwapForm: React.FunctionComponent<ConnectedSwapFormProps> = ({
  ...
  const targetAmm = amm;
  const positionAmm = position?.amm || amm;
  const resultVariableApy = targetAmm.variableApy;
  const resultFixedApr = targetAmm.fixedApr;
  ...
  return (
    <>
      ...
      <SwapForm
        ...
        endDate={DateTime.fromMillis(targetAmm.termEndTimestamp * 1000)}
        errors={form.errors}
        ...
        gaButtonId={getPoolButtonIdSDKV2(
          form.state.marginAction.toString(),
          '',
          getNotionalActionFromHintState(form.hintState),
          agent,
        ...
        startDate={DateTime.fromMillis(targetAmm.termStartTimestamp * 1000)}
        ...
        underlyingTokenName={targetAmm.tokenName}
        variableApy={resultVariableApy}
