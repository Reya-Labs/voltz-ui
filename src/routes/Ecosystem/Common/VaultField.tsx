...
export const VaultField: React.FunctionComponent<VaultFieldProps> = ({ expectedApy, maturity }: VaultFieldProps) => {
    return (<Box sx={{ marginTop: '16px', display: 'flex', maxWidth: '275px' }}>
        <Typography
            variant="body2"
