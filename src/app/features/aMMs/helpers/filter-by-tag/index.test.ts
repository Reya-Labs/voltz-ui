...
describe('filterByTag', () => {
  ...
  it('should return true when appliedFilters["v2"] is true and amm.market.tags.isV2 is true', () => {
    appliedFilters['v2'] = true;
    amm.market.tags.isV2 = true;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(true);
  });

  it('should return false when appliedFilters["v2"] is false and amm.market.tags.isV2 is true', () => {
    appliedFilters['v2'] = false;
    amm.market.tags.isV2 = true;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(false);
  });

  it('should return true when appliedFilters["borrow"] is true and amm.market.tags.isBorrowing is true', () => {
    appliedFilters['borrow'] = true;
    amm.market.tags.isBorrowing = true;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(true);
  });

  it('should return true when appliedFilters["yield"] is true and amm.market.tags.isYield is true', () => {
  ...
  it('should return false when appliedFilters["v2"] is true and amm.market.tags.isV2 is false', () => {
    appliedFilters['v2'] = true;
    amm.market.tags.isV2 = false;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(false);
  });

  it('should return false when appliedFilters["borrow"] is true and amm.market.tags.isBorrowing is false', () => {
    appliedFilters['borrow'] = true;
    amm.market.tags.isBorrowing = false;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(false);
  });

  it('should return false when appliedFilters["yield"] is true and amm.market.tags.isYield is false', () => {
    appliedFilters['yield'] = true;
    amm.market.tags.isYield = false;
    expect(filterByTag(amm as never, appliedFilters as never)).toBe(false);
  });

  it('should return false when appliedFilters["v2"] and appliedFilters["yield"] are true, but amm.market.tags.isV2 and amm.market.tags.isYield are false', () => {
    appliedFilters['v2'] = true;
    appliedFilters['yield'] = true;
    amm.market.tags.isV2 = false;
    amm.market.tags.isYield = false;
