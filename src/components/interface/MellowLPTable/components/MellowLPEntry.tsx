...
const MellowLPEntry: React.FunctionComponent<MellowLPEntryProps> = ({ lpVault }: MellowLPEntryProps) => {
    ...
    const renderContent = () => {
        return (
            <Box sx={{ maxWidth: "308px", maxHeight: "340px", width: "100%", height: "100%", filter: "drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))"}}>
                ...
                <Box sx={{marginLeft: "8px", marginTop: "16px"}}>
                    <LPMellowVaultInfo token={"USDC"} accumulative={43000} cap={80000}/>
                </Box>

                <Box sx={{marginLeft: "8px", marginTop: "16px"}}>
                    <MellowLPPosition handleClick={() => {}}/>
                </Box>
            </Box>
        )
    }
