...
import {
  VaultFormRoute as DeprecatedVaultFormRoute,
  VaultFormRoute,
} from './routes/LPOptimisers/VaultFormRoute/VaultFormRoute';
import { Vaults as DeprecatedVaults, Vaults } from './routes/LPOptimisers/Vaults/Vaults';
