  ...
  return (
    <LeverageFieldBox>
      <BrokoliLeverageField
        ...
        tooltip="Leverage is the notional amount divided by the margin amount. The more leverage you take the higher your potential fee income and funding rate risk"
