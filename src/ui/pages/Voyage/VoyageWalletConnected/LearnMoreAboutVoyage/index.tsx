...
const STEP_DESCRIPTION_MAP: Record<0 | 1 | 2, string> = {
  ...
  1: 'The first ever Voyage gives you the chance to gain early access to Voltz Protocol v2. If you meet the criteria required to earn the badge, you’ll become part of a unique set of users who will kick-start the exclusive voyager program and help us build out Voltz Protocol v2 as a v2 OG.',
