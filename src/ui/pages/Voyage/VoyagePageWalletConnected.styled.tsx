...
export const VoyageBadgesListBox = styled('div')`
  width: 100%;
  box-sizing: border-box;
  padding: 0 16px;
`;

export const BadgesListSubheading = styled(Typography)`
  margin-top: 8px;
`;

export const BadgesListGrid = styled(Grid)`
  margin-top: 16px;
  row-gap: 8px;
`;

export const VoyageBadgesGrid = styled(Grid)`
  margin-top: 24px;
  row-gap: 16px;
  column-gap: 16px;
`;
