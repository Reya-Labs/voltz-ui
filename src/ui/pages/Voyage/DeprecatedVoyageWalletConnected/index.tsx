...
export const DeprecatedVoyageWalletConnected: React.FunctionComponent<VoyagePageWalletConnectedProps> =
  ({ account, accountENS, chainId }) => {
    ...
    return (
      <ContainerBox>
        ...
        >
          ...
          at any time, providing a short period within which unique Soul-Bound-Tokens (aka Badges)
          can be earned.
          <br />
          <br />
