...
export const ProfilePageWalletConnected: React.FunctionComponent<
...
> = ({
  ...
  return (
    <ContainerBox>
      ...
      >
        Earn badges through your contribution to the community and activity on the protocol. Badges
        are earned throughout each Season, with minting available at the end of each Season. The
        more you collect the greater your contribution.{' '}
        <HighlightedText>{seasonLabel}</HighlightedText> {isOnGoingSeason ? 'runs' : 'ran'} between{' '}
        <HighlightedText>{seasonStartDateFormatted}</HighlightedText> and{' '}
