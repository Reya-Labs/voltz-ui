...
const ethereumBadgeTypeBadgeVariantMap: BadgeTypeBadgeVariant = {
  ...
  '-66': 's4FixedTrader',
  '-67': 's4DeltaDegen',
  '-68': 's4LeverageCrowbar',
  '-69': 's4IrsConnoisseur',
  '-70': 's4SushiRoll',
  '-71': 's4DegenStuff',
  '-72': 's4Lpoor',
  '-73': 's4MoneyMoneyMoney',
  '-74': 's4WaterHose',
  '-75': 's4RainMaker',
  '-76': 's4BeWaterMyFriend',
  '-77': 's4Yikes',
  '-78': 's4MaxBidding',
  '-79': 's4TopTrader',
  '-86': 's4MellowLpVaultTier1',
  '-87': 's4MellowLpVaultTier2',
  '-88': 's4MellowLpVaultTier3',
...
const arbitrumTypeBadgeVariantMap: BadgeTypeBadgeVariant = {
  ...
  // TODO: Ioana change to proper values
  // season 4
  '-66': 's4FixedTraderArbitrum',
  '-67': 's4DeltaDegenArbitrum',
  '-68': 's4LeverageCrowbarArbitrum',
  '-69': 's4IrsConnoisseurArbitrum',
  '-70': 's4SushiRollArbitrum',
  '-71': 's4DegenStuffArbitrum',
  '-72': 's4LpoorArbitrum',
  '-73': 's4MoneyMoneyMoneyArbitrum',
  '-74': 's4WaterHoseArbitrum',
  '-75': 's4RainMakerArbitrum',
  '-76': 's4BeWaterMyFriendArbitrum',
  '-77': 's4YikesArbitrum',
  '-78': 's4MaxBiddingArbitrum',
  '-79': 's4TopTraderArbitrum',
  '-86': 's4MellowLpVaultTier1Arbitrum',
  '-87': 's4MellowLpVaultTier2Arbitrum',
  '-88': 's4MellowLpVaultTier3Arbitrum',
};
