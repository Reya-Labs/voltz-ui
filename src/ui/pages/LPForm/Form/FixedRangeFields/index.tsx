  ...
  return (
    <FixedRangeFieldsBox>
      <CurrencyField
        ...
        suffix="%"
        tooltip="The lower rate of the fixed rate range within which to deposit liquidity"
      ...
      <CurrencyField
        ...
        labelTypographyToken={labelTypographyToken}
        suffix="%"
        tooltip="The upper rate of the fixed rate range within which to deposit liquidity"
        tooltipColorToken="lavenderWeb3"
