...
var BorrowAMM = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        normalizedTime = untilTimestamp
                            .sub(currentSwapTimestamp)
                            .div(ethers_1.BigNumber.from(constants_1.ONE_YEAR_IN_SECONDS));
    ...
    BorrowAMM.prototype.getVariableCashFlow = function (position) {
        return __awaiter(this, void 0, void 0, function () {
            var allSwaps, pastMaturity, _a, variableCashFlow;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = _b.sent(), variableCashFlow = _a[1];
    ...
    BorrowAMM.prototype.getFixedCashFlow = function (position) {
        return __awaiter(this, void 0, void 0, function () {
            var allSwaps, pastMaturity, fixedCashFlow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.atMaturity()];
                    case 1:
                        pastMaturity = _a.sent();
                        return [4 /*yield*/, this.getAccruedCashflow(allSwaps, pastMaturity)];
                    case 2:
                        fixedCashFlow = (_a.sent())[0];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, position.refreshInfo()];
                    case 2:
                        _a.sent();
                        notional = position.variableTokenBalance;
    ...
    BorrowAMM.prototype.getAggregatedBorrowBalance = function (position) {
        return __awaiter(this, void 0, void 0, function () {
            var variableCashFlow, notional, notionalWithVariableCashFlow, notionalWithVariableCashFlowAndBuffer, underlyingBorrowBalance, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getVariableCashFlow(position)];
                    case 1:
                        variableCashFlow = _c.sent();
                        return [4 /*yield*/, position.refreshInfo()];
                    case 2:
                        _c.sent();
                        notional = position.variableTokenBalance;
                        notionalWithVariableCashFlow = notional + this.amm.descale(variableCashFlow);
                        notionalWithVariableCashFlowAndBuffer = notionalWithVariableCashFlow * 1.001;
                        _b = (_a = this.amm).descale;
                        return [4 /*yield*/, this.getScaledUnderlyingBorrowBalance()];
                    case 3:
                        underlyingBorrowBalance = _b.apply(_a, [_c.sent()]);
                        if (underlyingBorrowBalance >= notionalWithVariableCashFlowAndBuffer) {
                            return [2 /*return*/, underlyingBorrowBalance - notionalWithVariableCashFlow];
                        }
                        return [2 /*return*/, 0];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        termStartTimestamp = ethers_1.BigNumber.from(this.termStartTimestamp.toString())
                            .div(ethers_1.BigNumber.from(10).pow(18))
                            .toNumber();
                        termEndTimestamp = ethers_1.BigNumber.from(this.termEndTimestamp.toString())
                            .div(ethers_1.BigNumber.from(10).pow(18))
                            .toNumber();
                        fixedFactor = ((termEndTimestamp - termStartTimestamp) / constants_1.ONE_YEAR_IN_SECONDS) * 0.01;
                        fcMargin = -(infoPostSwap.fixedTokenDeltaBalance * fixedFactor +
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, priceFetch_1.geckoEthToUsd)(process.env.REACT_APP_COINGECKO_API_KEY || '')];
                    case 2:
...
//# sourceMappingURL=borrowAMM.js.map