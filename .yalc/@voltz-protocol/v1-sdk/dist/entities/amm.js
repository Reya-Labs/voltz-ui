...
var AMM = /** @class */ (function () {
    ...
    AMM.prototype.getExpectedApyInfo = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, signerAddress, marginEngineContract, currentMargin, rateOracleContract, lastBlock, lastBlockTimestamp, _b, _c, scaledCurrentMargin, positionMargin, accruedCashflow, positionUft, positionVt, _i, _d, swap, accruedCashflowInfo, error_4, _e, expectedApy, expectedCashflow, result;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 10:
                        _e = _f.sent(), expectedApy = _e[0], expectedCashflow = _e[1];
                        result = {
    ...
    AMM.prototype.swap = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, sqrtPriceLimitX96, tickLimit, factoryContract, peripheryAddress, peripheryContract, scaledNotional, swapPeripheryParams, tempOverrides, scaledMarginDelta, swapTransaction, estimatedGas, rateOracleContract, variableFactorFromStartToNowWad, estimatedGas, receipt, error_5;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.swapWithWeth = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, sqrtPriceLimitX96, tickLimit, factoryContract, peripheryAddress, peripheryContract, scaledNotional, swapPeripheryParams, tempOverrides, scaledMarginDelta, estimatedGas, swapTransaction, receipt, error_6;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.mintWithWeth = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, factoryContract, peripheryAddress, peripheryContract, _notional, mintOrBurnParams, tempOverrides, scaledMarginDelta, estimatedGas, mintTransaction, receipt, error_8;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.burn = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, factoryContract, peripheryAddress, peripheryContract, _notional, mintOrBurnParams, estimatedGas, burnTransaction, receipt, error_9;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.updatePositionMargin = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, tempOverrides, scaledMarginDelta, factoryContract, peripheryAddress, peripheryContract, estimatedGas, updatePositionMarginTransaction, receipt, error_10;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.liquidatePosition = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tickUpper, tickLower, marginEngineContract, estimatedGas, liquidatePositionTransaction, receipt, error_11;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.settlePosition = function (_a) {
        var owner = _a.owner, fixedLow = _a.fixedLow, fixedHigh = _a.fixedHigh;
        return __awaiter(this, void 0, void 0, function () {
            var effectiveOwner, _b, tickUpper, tickLower, factoryContract, peripheryAddress, peripheryContract, estimatedGas, settlePositionTransaction, receipt, error_12;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
    ...
    AMM.prototype.fcmSwap = function (_a) {
        var notional = _a.notional, fixedRateLimit = _a.fixedRateLimit;
        return __awaiter(this, void 0, void 0, function () {
            var sqrtPriceLimitX96, tickLimit, fcmContract, scaledNotional, estimatedGas, fcmSwapTransaction, receipt, error_13;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    AMM.prototype.fcmUnwind = function (_a) {
        var notionalToUnwind = _a.notionalToUnwind, fixedRateLimit = _a.fixedRateLimit;
        return __awaiter(this, void 0, void 0, function () {
            var sqrtPriceLimitX96, tickLimit, fcmContract, scaledNotional, estimatedGas, fcmUnwindTransaction, receipt, error_14;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 6:
                        error_14 = _b.sent();
                        sentry_1.sentryTracker.captureException(error_14);
                        sentry_1.sentryTracker.captureMessage("Transaction Confirmation Error");
                        throw new Error("Transaction Confirmation Error");
                    case 7: return [2 /*return*/];
                }
    ...
    AMM.prototype.settleFCMTrader = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fcmContract, estimatedGas, fcmSettleTraderTransaction, receipt, error_15;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 6:
                        error_15 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_15);
                        sentry_1.sentryTracker.captureMessage("Transaction Confirmation Error");
                        throw new Error("Transaction Confirmation Error");
                    case 7: return [2 /*return*/];
                }
    ...
    AMM.prototype.approveFCM = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isApproved, factoryContract, estimatedGas, approvalTransaction, receipt, error_16;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        error_16 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_16);
                        sentry_1.sentryTracker.captureMessage("Transaction Confirmation Error");
                        throw new Error("Transaction Confirmation Error");
                    case 7: return [2 /*return*/];
                }
    ...
    AMM.prototype.approveUnderlyingTokenForPeriphery = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isApproved, tokenAddress, token, factoryContract, peripheryAddress, estimatedGas, approvalTransaction, receipt, error_17;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.underlyingToken.id) {
                    ...
                    case 10:
                        error_17 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_17);
    ...
    AMM.prototype.approveUnderlyingTokenForFCM = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isApproved, tokenAddress, token, estimatedGas, approvalTransaction, receipt, error_18;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        error_18 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_18);
                        sentry_1.sentryTracker.captureMessage("Token approval failed");
                        throw new Error("Token approval failed");
                    case 7: return [2 /*return*/];
                }
    ...
    AMM.prototype.approveYieldBearingTokenForFCM = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isApproved, tokenAddress, _a, fcmContract, fcmContract, token, estimatedGas, approvalTransaction, receipt, error_19;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 12:
                        error_19 = _b.sent();
                        sentry_1.sentryTracker.captureException(error_19);
                        sentry_1.sentryTracker.captureMessage("Token approval failed");
                        throw new Error("Token approval failed");
                    case 13: return [2 /*return*/];
                }
    ...
    AMM.prototype.getVariableFactor = function (termStartTimestamp, termEndTimestamp) {
        return __awaiter(this, void 0, void 0, function () {
            var rateOracleContract, result, resultScaled, error_20;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.provider) {
                    ...
                    case 3:
                        error_20 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_20);
    ...
    AMM.prototype.getPositionInformation = function (position) {
        return __awaiter(this, void 0, void 0, function () {
            var usdExchangeRate, results, rateOracleContract, signerAddress, lastBlock, lastBlockTimestamp, _a, _b, beforeMaturity, _c, _d, _e, accruedCashflowInfo, error_21, accruedCashflowInfo, error_22, _f, fcmContract, margin, marginInUnderlyingToken, fcmContract, margin, cTokenAddress, cTokenContract, rate, scaledRate, marginInUnderlyingToken, tickLower, tickUpper, marginEngineContract, rawPositionInfo, marginInUnderlyingToken, liquidationThreshold, error_23, safetyThreshold, error_24, notionalInUnderlyingToken, fixedApr;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 6:
                        ...
                        _g.label = 7;
                    case 7:
                        if (!(!beforeMaturity && !position.isSettled)) return [3 /*break*/, 9];
                        _d = results;
                        return [4 /*yield*/, position.getSettlementCashflow()];
                    case 8:
                        _d.settlementCashflow = _g.sent();
                        _g.label = 9;
                    case 9:
                        if (!(position.swaps.length > 0)) return [3 /*break*/, 19];
                        if (!beforeMaturity) return [3 /*break*/, 15];
                        _g.label = 10;
                    case 10:
                    ...
                    case 11:
                        _e.variableRateSinceLastSwap = (_g.sent()) * 100;
                    ...
                    case 13:
                        error_21 = _g.sent();
                        sentry_1.sentryTracker.captureException(error_21);
                        return [3 /*break*/, 14];
                    case 14: return [3 /*break*/, 19];
                    case 15:
                        if (!!position.isSettled) return [3 /*break*/, 19];
                        _g.label = 16;
                    case 16:
                    ...
                    case 18:
                        error_22 = _g.sent();
                        sentry_1.sentryTracker.captureException(error_22);
                        return [3 /*break*/, 19];
                    case 19:
                    ...
                    case 29:
                        ...
                        if (!beforeMaturity) return [3 /*break*/, 37];
                        _g.label = 30;
                    case 30:
                    ...
                    case 32:
                        error_23 = _g.sent();
                        sentry_1.sentryTracker.captureException(error_23);
                        return [3 /*break*/, 33];
                    case 33:
                    ...
                    case 35:
                        error_24 = _g.sent();
                        sentry_1.sentryTracker.captureException(error_24);
                        return [3 /*break*/, 36];
                    case 36:
    ...
    AMM.prototype.setCap = function (amount) {
        return __awaiter(this, void 0, void 0, function () {
            var factoryContract, peripheryAddress, peripheryContract, marginEngineContract, vammAddress, vammContract, isAlphaTransaction, error_25, isAlphaTransactionME, error_26, setCapTransaction, error_27;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.signer) {
                    ...
                    case 6:
                        error_25 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_25);
                        sentry_1.sentryTracker.captureMessage("Setting Alpha failed");
                    ...
                    case 11:
                        error_26 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_26);
                        sentry_1.sentryTracker.captureMessage("Setting Alpha failed");
                        throw new Error("Setting Alpha failed");
                    ...
                    case 16:
                        error_27 = _a.sent();
                        sentry_1.sentryTracker.captureException(error_27);
                        sentry_1.sentryTracker.captureMessage("Setting cap failed");
