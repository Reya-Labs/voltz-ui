...
function getScores(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var activityQuery, client, scores, skip, data, wallets, _i, wallets_1, wallet, score, _d, _e, position, token, decimals, termEnd, args, burnArgs, mintArgs, swapArgs;
            ...
            switch (_f.label) {
                case 0:
                    ...
                    client = new client_1.ApolloClient({
                        ...
                        link: new client_1.HttpLink({ uri: subgraphUrl, fetch: fetch })
                    });
                    scores = {};
                    skip = 0;
                    _f.label = 1;
                    ...
                    for (_i = 0, wallets_1 = wallets; _i < wallets_1.length; _i++) {
                        ...
                        for (_d = 0, _e = wallet.positions; _d < _e.length; _d++) {
                            ...
                            if (isLP) {
                                ...
                                mintArgs = __assign(__assign({}, args), { actionType: ActionType.MINT, actions: position.mints });
