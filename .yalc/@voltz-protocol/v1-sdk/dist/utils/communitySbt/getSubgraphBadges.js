...
function getSubgraphBadges(_a) {
    var _b;
    var userId = _a.userId, seasonId = _a.seasonId, badgesSubgraphUrl = _a.badgesSubgraphUrl;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    badgeQuery = "\n                query( $id: String) {\n                    seasonUser(id: $id) {\n                        id\n                        badges {\n                        id\n                        awardedTimestamp\n                        mintedTimestamp\n                        badgeType\n                        }\n                    }\n                }\n            ";
                    client = (0, getApolloClient_1.getApolloClient)(badgesSubgraphUrl);
...
//# sourceMappingURL=getSubgraphBadges.js.map