...
var TickMath = /** @class */ (function () {
    ...
    TickMath.getSqrtRatioAtTick = function (tick) {
        ...
        // back to Q96
        return jsbi_1.default.greaterThan(jsbi_1.default.remainder(ratio, Q32), constants_1.ZERO)
            ? jsbi_1.default.add(jsbi_1.default.divide(ratio, Q32), constants_1.ONE)
