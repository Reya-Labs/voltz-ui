...
var getErrorSignature = function (error, environment) {
    switch (environment) {
        case 'LOCALHOST_SDK': {
            ...
            var extractedMessage = (0, exports.extractErrorSignature)(message);
            sentry_1.sentryTracker.captureException(new Error(message));
            sentry_1.sentryTracker.captureMessage(extractedMessage);
        ...
        case 'LOCALHOST_UI': {
            try {
                ...
                if (reason.startsWith('0x08c379a0')) {
                    sentry_1.sentryTracker.captureException(new Error('Error LOCALHOST_UI. reason starts with 0x08c379a0'));
                    return 'Error';
                }
                ...
                sentry_1.sentryTracker.captureException(err);
                sentry_1.sentryTracker.captureMessage(err.message);
        ...
        case 'KOVAN': {
            try {
                ...
                if (reason.startsWith('0x08c379a0')) {
                    sentry_1.sentryTracker.captureException(new Error('Error KOVAN. reason starts with 0x08c379a0'));
                    return 'Error';
                }
                var decodedError = exports.iface.parseError(reason);
            ...
            try {
                ...
                if (typeof error.error.data === 'string') {
                    ...
                    if (typeof error.error.data.originalError.data === 'string') {
                        ...
                        sentry_1.sentryTracker.captureMessage("typeof error.error.data.originalError.data is not string");
                        throw new Error('Unrecognized error type');
                    }
                }
                if (reason.startsWith('0x08c379a0')) {
                    sentry_1.sentryTracker.captureException(new Error('Error MAINNET. reason starts with 0x08c379a0'));
                    return 'Error';
                }
                var decodedError = exports.iface.parseError(reason);
                var errSig = decodedError.signature.split('(')[0];
        ...
        default: {
            sentry_1.sentryTracker.captureMessage("Unrecognized network for decoding errors");
            ...
            case 'MAINNET': {
                ...
                if (typeof error.error.data === 'string') {
                    ...
                    if (typeof error.error.data.originalError.data === 'string') {
                        ...
                        sentry_1.sentryTracker.captureException(error);
                        sentry_1.sentryTracker.captureMessage("Unrecognized error type");
                        throw new Error('Unrecognized error type');
                    }
                }
                try {
...
var decodeInfoPostMint = function (error, environment) {
    ...
    sentry_1.sentryTracker.captureException((0, exports.getReadableErrorMessage)(error, environment));
    sentry_1.sentryTracker.captureMessage((0, exports.getReadableErrorMessage)(error, environment));
