...
exports.geckoEthToUsd = void 0;
var axios_1 = __importDefault(require("axios"));
var sentry_1 = require("./sentry");
var geckoEthToUsd = function (apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    var attempts, attempt, data, error_1;
        ...
        switch (_a.label) {
            ...
            case 4:
                ...
                if (attempt + 1 === attempts) {
                    ...
                    sentry_1.sentryTracker.captureMessage('Unable to fetch ETH price after 5 attempts');
                }
                return [3 /*break*/, 5];
            case 5:
                attempt += 1;
...
//# sourceMappingURL=priceFetch.js.map