...
var typechain_1 = require("../src/typechain");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, vammContract.initializeVAMM(tickMath_1.TickMath.getSqrtRatioAtTick(-23000).toString())];
            case 1:
                _a.sent(); // 10%
                fixedLowMinter = 8;
                fixedHighMinter = 12;
