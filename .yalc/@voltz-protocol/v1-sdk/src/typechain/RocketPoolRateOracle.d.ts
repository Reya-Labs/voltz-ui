...
interface RocketPoolRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class RocketPoolRateOracle extends BaseContract {
  ...
  interface: RocketPoolRateOracleInterface;
