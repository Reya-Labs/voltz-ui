...
interface TestLidoRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class TestLidoRateOracle extends BaseContract {
  ...
  interface: TestLidoRateOracleInterface;
