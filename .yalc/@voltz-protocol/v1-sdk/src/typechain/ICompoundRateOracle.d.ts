...
interface ICompoundRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ICompoundRateOracle extends BaseContract {
  ...
  interface: ICompoundRateOracleInterface;
