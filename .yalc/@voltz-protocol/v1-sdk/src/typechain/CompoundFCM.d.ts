...
interface CompoundFCMInterface extends ethers.utils.Interface {
  functions: {
    "cToken()": FunctionFragment;
    "getTraderMarginInCTokens(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getTraderMarginInCTokens",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class CompoundFCM extends BaseContract {
  ...
  interface: CompoundFCMInterface;
