...
interface IRocketPoolRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IRocketPoolRateOracle extends BaseContract {
  ...
  interface: IRocketPoolRateOracleInterface;
