...
interface MockCInterestRateModelInterface extends ethers.utils.Interface {
  functions: {
...
export class MockCInterestRateModel extends BaseContract {
  ...
  interface: MockCInterestRateModelInterface;
