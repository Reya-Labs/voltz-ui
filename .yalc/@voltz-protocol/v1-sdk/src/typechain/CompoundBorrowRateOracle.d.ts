...
interface CompoundBorrowRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundBorrowRateOracle extends BaseContract {
  ...
  interface: CompoundBorrowRateOracleInterface;
