...
interface TestCompoundBorrowRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class TestCompoundBorrowRateOracle extends BaseContract {
  ...
  interface: TestCompoundBorrowRateOracleInterface;
