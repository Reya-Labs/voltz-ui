...
import type {
  IRocketPoolRateOracle,
  IRocketPoolRateOracleInterface,
} from "../IRocketPoolRateOracle";
...
export class IRocketPoolRateOracle__factory {
  static readonly abi = _abi;
  static createInterface(): IRocketPoolRateOracleInterface {
    return new utils.Interface(_abi) as IRocketPoolRateOracleInterface;
  }
  static connect(
    address: string,
