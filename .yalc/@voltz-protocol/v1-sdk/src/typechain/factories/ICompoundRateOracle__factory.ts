...
import type {
  ICompoundRateOracle,
  ICompoundRateOracleInterface,
} from "../ICompoundRateOracle";
...
export class ICompoundRateOracle__factory {
  static readonly abi = _abi;
  static createInterface(): ICompoundRateOracleInterface {
    return new utils.Interface(_abi) as ICompoundRateOracleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICompoundRateOracle {
    return new Contract(address, _abi, signerOrProvider) as ICompoundRateOracle;
  }
}
