...
export class IPeripheryOld__factory {
  static readonly abi = _abi;
  static createInterface(): IPeripheryOldInterface {
    return new utils.Interface(_abi) as IPeripheryOldInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPeripheryOld {
    return new Contract(address, _abi, signerOrProvider) as IPeripheryOld;
  }
}
