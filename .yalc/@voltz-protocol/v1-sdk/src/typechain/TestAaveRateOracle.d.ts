...
interface TestAaveRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class TestAaveRateOracle extends BaseContract {
  ...
  interface: TestAaveRateOracleInterface;
