...
interface TestCompoundRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class TestCompoundRateOracle extends BaseContract {
  ...
  interface: TestCompoundRateOracleInterface;
