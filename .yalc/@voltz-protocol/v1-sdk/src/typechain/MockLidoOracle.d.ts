...
interface MockLidoOracleInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "mockStEth", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "mockStEth", data: BytesLike): Result;

  events: {};
}

export class MockLidoOracle extends BaseContract {
  ...
  interface: MockLidoOracleInterface;
  ...
  functions: {
    ...
    mockStEth(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    mockStEth(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    mockStEth(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
