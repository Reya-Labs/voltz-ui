...
interface CompoundFCMStorageInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundFCMStorage extends BaseContract {
  ...
  interface: CompoundFCMStorageInterface;
