...
interface AaveBorrowRateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class AaveBorrowRateOracle extends BaseContract {
  ...
  interface: AaveBorrowRateOracleInterface;
