...
interface TestVAMMInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setFixedTokenGrowthGlobal(int256)": FunctionFragment;
    "setIsAlpha(bool)": FunctionFragment;
    "setTestProtocolFees(uint256)": FunctionFragment;
    "setTickTest(int24,(uint128,int128,int256,int256,uint256,bool))": FunctionFragment;
    "setVariableTokenGrowthGlobal(int256)": FunctionFragment;
    "swap((address,int256,uint160,int24,int24))": FunctionFragment;
    "testGetAMMTermEndTimestamp()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setFixedTokenGrowthGlobal",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "setIsAlpha", values: [boolean]): string;
  encodeFunctionData(
    functionFragment: "setTestProtocolFees",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setTickTest",
    values: [
      BigNumberish,
      {
  ...
  encodeFunctionData(
    functionFragment: "setVariableTokenGrowthGlobal",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testGetAMMTermEndTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class TestVAMM extends BaseContract {
  ...
  getCurrentTick(overrides?: CallOverrides): Promise<number>;
  ...
  estimateGas: {
    ...
    checkMaturityDuration(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getCurrentTick(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getCurrentTick(overrides?: CallOverrides): Promise<PopulatedTransaction>;
